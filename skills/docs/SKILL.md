...
**What goes in it:** anything a session leaves undone — a follow-up, a deferred decision, a bug found but not fixed, an open question. Anything bigger than a line item gets promoted to its own `INTENT.md` (`sdsi:workflow`).
