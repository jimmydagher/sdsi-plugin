...
Language-neutral. Distilled from building `ariel` (job, workforce, and spend data from several source systems into a financial system of record and on to a warehouse); grow it from a second real project, not speculation.
